    ...
    public MyTestResource(){
    	{
            ...
            bd1.setClazz("com.myspring.test.threads.Hello"); //设置bean的clazz路径
    	...
    	}
    	{
            ...
            bd2.setClazz("com.myspring.test.threads.Hello");
    	...
    	}
    	{
            ...
            bd3.setClazz("com.myspring.test.threads.MessageInt");
    	...
    	}
    	{
    		...
    		BeanDefinition bd3 = new BeanDefinition();
            bd3.setId("refMsgStr");
            bd3.setClazz("com.myspring.test.threads.MessageString");
